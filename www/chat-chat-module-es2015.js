...
let ChatPage = class ChatPage {
    constructor(speechRecognition, cd, chat, appRef) {
        ...
        statringMsg.forEach(msg => {
            const botMessage = new _services_chat_service__WEBPACK_IMPORTED_MODULE_3__["Message"](msg.content, 'bot');
    ...
    startListening() {
        this.speechRecognition.startListening()
            .subscribe((matches) => {
            this.appRef.isStable.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])(stable => stable), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(() => Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["interval"])(1000))).subscribe(counter => {
                if (counter == 0) {
